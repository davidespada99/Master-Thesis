...
Firstly, a deeper overview of the Internet of Things is given, with a focus on its technical aspects and architecture. This includes a survey of the communication protocol stack, from the physical and network layers to the transport and application layers. This is followed by the enabling technologies that make it possible, from the hardware components to the wireless communicvation protocols and the two most important communications paradigmas. \

In particular, the two most widely adopted IoT communication protocols, MQTT and CoAP are analyzed in detail, along with other notable protocols. For this two, we will examine their main characteristics and operational mechanisms and ther security features.
